...
class RegisterForm extends Form
{
    ...
    {
        // Name
        $name = new Text('registration_name');
        ...
        // Login
        $name = new Text('registration_username');
        ...
        // Email
        $email = new Text('registration_email');
        ...
        // Password
        $password = new Password('registration_password');
        $password->setLabel('Password');
        $password->addValidators([new PresenceOf(['message' => 'Password is required'])]);
        $this->add($password);

        // Confirm Password
        $repeatPassword = new Password('registration_repeatPassword');
